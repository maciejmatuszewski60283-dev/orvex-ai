document.addEventListener('DOMContentLoaded', () => {
  ...
  // Zabezpieczenie przed enterem (wysyłanie na PC, choć celujemy w mobile)
  ...
  function appendMessage(text, isUser, imgSrc = null) {
    ...
    // Płynne przewijanie do nowej wiadomości
    setTimeout(() => {
  ...
  chatForm.addEventListener('submit', (e) => {
    ...
    // Pobranie danych obrazka (jeśli jest) do wyświetlenia w czacie
    ...
    // Symulacja odpowiedzi AI (Tutaj w przyszłości podepniemy API)
    setTimeout(() => {
      appendMessage("Odebrałem Twoją wiadomość. Obecnie działam w trybie interfejsu (Front-end), więc logika backendu czeka na podłączenie API.", false);
    }, 1000);
  });
});
